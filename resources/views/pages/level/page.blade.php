...
<div id ="main">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">For level to check user list</p>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    @include('pages.level.table')
                    </div>
            </div>
        </div>
    </div>
</div>
@include('pages.level.modal')
@section('plugin')
    <script src="{{ asset('js/pages/level.js') }}" type="text/javascript"></script>

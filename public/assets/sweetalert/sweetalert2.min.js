(function (e, t) {
    ...
    function n(e) {
        ...
        var t, n = I(), o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
        ...
        var i = M(), l = H(), d = W().querySelector("#" + k.content), u = Y(), c = F(), p = Q(), g = X(), m = J();
        ...
        var b = K(), v = parseInt(null === e.currentProgressStep ? Oe.getQueueStep() : e.currentProgressStep, 10);
        e.progressSteps && e.progressSteps.length ? (T(b), q(b), v >= e.progressSteps.length && f("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function (t, n) {
            var o = document.createElement("li");
            if (L(o, k.progresscircle), o.innerHTML = t, n === v && L(o, k.activeprogressstep), b.appendChild(o), n !== e.progressSteps.length - 1) {
                var i = document.createElement("li");
                L(i, k.progressline), e.progressStepsDistance && (i.style.width = e.progressStepsDistance), b.appendChild(i)
            }
        })) : V(b);
        for (var w = N(), C = 0; C < w.length; C++) V(w[C]);
        if (e.type) {
            var x = !1;
        ...
        oe(e.footer, m), !0 === e.animation ? O(t, k.noanimation) : L(t, k.noanimation), e.showLoaderOnConfirm && !e.preConfirm && f("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")
    }
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        E = function (e, t) {
            ...
            var e = Array.prototype.slice.call(I().querySelectorAll("[tabindex]:not([tabindex=\"-1\"]):not([tabindex=\"0\"])")).sort(function (e, t) {
                    return (e = parseInt(e.getAttribute("tabindex")), t = parseInt(t.getAttribute("tabindex")), e > t) ? 1 : e < t ? -1 : 0
                }),
                t = Array.prototype.slice.call(I().querySelectorAll("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex=\"0\"], [contenteditable], audio[controls], video[controls]"));
            return g(e.concat(t))
        }, Z = function () {
        ...
        ne = function (e) {
            var t = M();
            if (t && (t.parentNode.removeChild(t), O([document.documentElement, document.body], [k["no-backdrop"], k["has-input"], k["toast-shown"]])), ee()) return void h("SweetAlert2 requires document to initialize");
            var n = document.createElement("div");
            n.className = k.container, n.innerHTML = te;
            var o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
            o.appendChild(n);
            var i = I(), a = W(), r = _(a, k.input), s = _(a, k.file), l = a.querySelector("." + k.range + " input"),
                d = a.querySelector("." + k.range + " output"), u = _(a, k.select),
                c = a.querySelector("." + k.checkbox + " input"), p = _(a, k.textarea);
            ...
            return r.oninput = g, s.onchange = g, u.onchange = g, c.onchange = g, p.oninput = g, l.oninput = function () {
                g(), d.value = l.value
            }, l.onchange = function () {
                g(), l.nextSibling.value = l.value
            }, i
        }, oe = function (e, t) {
            if (!e) return V(t);
            ...
            var n = M(), o = I();
            if (o) {
                null !== e && "function" == typeof e && e(o), O(o, k.show), L(o, k.hide);
                var i = function () {
                    $() || (ce(), window.onkeydown = ue.previousWindowKeyDown, ue.windowOnkeydownOverridden = !1), n.parentNode && n.parentNode.removeChild(n), O([document.documentElement, document.body], [k.shown, k["no-backdrop"], k["has-input"], k["toast-shown"]]), Z() && (se(), de()), null !== t && "function" == typeof t && setTimeout(function () {
                        t()
                    })
                };
            ...
            for (var t in e) fe(t) || f("Unknown parameter \"" + t + "\""), he(t) && b("The parameter \"" + t + "\" is deprecated and will be removed in the next major release.")
        }, be = {}, ve = [], we = function (e, t) {
            ...
            isValidParameter: fe, isDeprecatedParameter: he, argsToParams: function (e) {
                ...
                return Q().click()
            }, getPopup: I, getTitle: H, getContent: W, getImage: U, getButtonsWrapper: function () {
                return b("swal.getButtonsWrapper() is deprecated and will be removed in the next major release, use swal.getActions() instead"), R(k.actions)
            }, getActions: Y, getConfirmButton: F, getCancelButton: Q, getFooter: J, isLoading: function () {
    ...
    var Ae = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap}, Ee = {
        ...
        var o = M(), i = I();
        null !== t && "function" == typeof t && t(i), e ? (L(i, k.show), L(o, k.fade), O(i, k.hide)) : O(i, k.fade), T(i), o.style.overflowY = "hidden", ie && !E(i, k.noanimation) ? i.addEventListener(ie, function e() {
            i.removeEventListener(ie, e), o.style.overflowY = "auto"
        }) : o.style.overflowY = "auto", L([document.documentElement, document.body, o], k.shown), Z() && (re(), le()), ue.previousActiveElement || (ue.previousActiveElement = document.activeElement), null !== n && "function" == typeof n && setTimeout(function () {
            n(i)
        })
    }, Pe = Object.freeze({
        hideLoading: t, disableLoading: t, getInput: function (e) {
            ...
            return new Promise(function (e, n) {
                ...
                }, y = r.popup.querySelectorAll("button"), b = 0; b < y.length; b++) y[b].onclick = f, y[b].onmouseover = f, y[b].onmouseout = f, y[b].onmousedown = f;
                ...
                o.toast && ue.windowOnkeydownOverridden && (window.onkeydown = ue.previousWindowKeyDown, ue.windowOnkeydownOverridden = !1), o.toast || ue.windowOnkeydownOverridden || (ue.previousWindowKeyDown = window.onkeydown, ue.windowOnkeydownOverridden = !0, window.onkeydown = function (n) {
                    var i = n || window.event;
                    if ("Enter" === i.key && !i.isComposing) {
                        if (i.target && t.getInput() && i.target.outerHTML === t.getInput().outerHTML) {
                            if (-1 !== ["textarea", "file"].indexOf(o.input)) return;
                            l.clickConfirm(), i.preventDefault()
                        }
                    } else if ("Tab" === i.key) {
                        for (var e = i.target || i.srcElement, a = G(o.focusCancel), s = -1, u = 0; u < a.length; u++) if (e === a[u]) {
                            s = u;
                            break
                        }
                ...
                for (var x = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], B = void 0, A = 0; A < x.length; A++) {
                    ...
                    if (B = t.getInput(x[A]), B) {
                        for (var O in B.attributes) if (B.attributes.hasOwnProperty(O)) {
                ...
                switch (o.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var R = _(r.content, k.range), I = R.querySelector("input"), N = R.querySelector("output");
    ...
    var Oe = e(function (e) {
        var t = function (t) {
            ...
            return d(n, t), r(n, [{
                key: "_main", value: function (e) {
                    return l(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "_main", this).call(this, s({}, be, e))
                }
            }], [{
                key: "setDefaults", value: function (t) {
                    if (b("\"setDefaults\" & \"resetDefaults\" methods are deprecated in favor of \"mixin\" method and will be removed in the next major release. For new projects, use \"mixin\". For past projects already using \"setDefaults\", support will be provided through an additional package."), !t || "object" !== ("undefined" == typeof t ? "undefined" : a(t))) throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");
                    ye(t), Object.keys(t).forEach(function (n) {
                        e.isValidParameter(n) && (be[n] = t[n])
                    })
                }
            }, {
                key: "resetDefaults", value: function () {
                    b("\"setDefaults\" & \"resetDefaults\" methods are deprecated in favor of \"mixin\" method and will be removed in the next major release. For new projects, use \"mixin\". For past projects already using \"setDefaults\", support will be provided through an additional package."), be = {}
                }
            }]), n
        }(e);
